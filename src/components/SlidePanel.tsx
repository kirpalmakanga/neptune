...
const SlidePanel: ParentComponent<Props> = (props) => (
    <Portal mount={document.querySelector('#slide-panel') as Node}>
        ...
        <Transition name="slide-left">
            <Show when={props.isVisible}>
                <section class="fixed top-0 right-0 bottom-0 shadow z-11 bg-primary-900 w-1/3">
                    <header class="flex items-center gap-4 p-4 mb-4 border-b-1 border-primary-100">
                        <Button
